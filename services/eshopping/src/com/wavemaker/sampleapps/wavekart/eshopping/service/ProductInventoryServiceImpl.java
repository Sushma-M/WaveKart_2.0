...
public class ProductInventoryServiceImpl implements ProductInventoryService {
	...
	@Override
	public ProductInventory getById(Integer productinventoryId) throws EntityNotFoundException {
        LOGGER.debug("Finding ProductInventory by id: {}", productinventoryId);
        ProductInventory productInventory = this.wmGenericDao.findById(productinventoryId);
    ...
    @Transactional(value = "eshoppingTransactionManager")
	@Override
	public ProductInventory delete(Integer productinventoryId) throws EntityNotFoundException {
