...
public class UserAddressDetailsServiceImpl implements UserAddressDetailsService {
	...
	@Override
	public UserAddressDetails getById(Integer useraddressdetailsId) throws EntityNotFoundException {
        LOGGER.debug("Finding UserAddressDetails by id: {}", useraddressdetailsId);
        UserAddressDetails userAddressDetails = this.wmGenericDao.findById(useraddressdetailsId);
    ...
    @Transactional(value = "eshoppingTransactionManager")
	@Override
	public UserAddressDetails delete(Integer useraddressdetailsId) throws EntityNotFoundException {
