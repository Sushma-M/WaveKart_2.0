...
public class OrderLineItemsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public OrderLineItems getOrderLineItems(@RequestParam(value = "orderId", required = true) Integer orderId, @RequestParam(value = "productId", required = true) Integer productId) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public OrderLineItems editOrderLineItems(@RequestParam(value = "orderId", required = true) Integer orderId, @RequestParam(value = "productId", required = true) Integer productId, @RequestBody OrderLineItems orderLineItems) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOrderLineItems(@RequestParam(value = "orderId", required = true) Integer orderId, @RequestParam(value = "productId", required = true) Integer productId) throws EntityNotFoundException {
        OrderLineItemsId orderlineitemsId = new OrderLineItemsId();
        orderlineitemsId.setOrderId(orderId);
        orderlineitemsId.setProductId(productId);
    ...
    @ApiOperation(value = "Returns the total count of OrderLineItems instances.")
