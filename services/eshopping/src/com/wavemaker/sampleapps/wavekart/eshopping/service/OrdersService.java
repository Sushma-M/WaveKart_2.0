...
public interface OrdersService {
    ...
    /*
     * Returns the associated orderLineItemses for given Orders id.
     *
     * @param orderId value of orderId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<OrderLineItems> findAssociatedOrderLineItemses(Integer orderId, Pageable pageable);
