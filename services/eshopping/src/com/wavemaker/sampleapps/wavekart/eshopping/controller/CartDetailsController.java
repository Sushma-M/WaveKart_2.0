...
public class CartDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public CartDetails getCartDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public CartDetails editCartDetails(@PathVariable("id") Integer id, @RequestBody CartDetails cartDetails) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteCartDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<CartDetails> searchCartDetailsByQueryFilters(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering CartDetails list");
    ...
    @ApiOperation(value = "Returns the total count of CartDetails instances.")
