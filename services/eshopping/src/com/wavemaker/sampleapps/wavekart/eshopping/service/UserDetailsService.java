...
public interface UserDetailsService {
    ...
    /**
	 * Find and return the UserDetails for given emailAddress  if exists.
	 *
	 * @param emailAddress value of emailAddress; value cannot be null.
	 * @return UserDetails associated with the given inputs.
     * @throws EntityNotFoundException if no matching UserDetails found.
	 */
    UserDetails getByEmailAddress(String emailAddress)throws EntityNotFoundException;
    ...
    /*
     * Returns the associated userAddressDetailses for given UserDetails id.
     *
     * @param userId value of userId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated UserAddressDetails instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<UserAddressDetails> findAssociatedUserAddressDetailses(Integer userId, Pageable pageable);

    /*
     * Returns the associated orderses for given UserDetails id.
     *
     * @param userId value of userId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     ...
     * @see Page
     */
    Page<Orders> findAssociatedOrderses(Integer userId, Pageable pageable);
